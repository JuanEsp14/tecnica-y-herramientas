// ==UserScript==
// @name         AugmenterLaPaginaMillonaria
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Augmenter La Pagina Millonaria!
// @author       You
// @match        https://lapaginamillonaria.com/
// @grant        GM_setValue
// @grant        GM_getValue
    ...
    return new Promise(resolve => {
        GM_xmlhttpRequest ( {
            ...
            onload:     function (response) {
                ...
                let themes = doc.getElementsByClassName("mod mod-tags")[0].getElementsByTagName("li");
